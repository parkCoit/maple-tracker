...
if char_data:
    ...
    html_code = f'<div style="display:flex;justify-content:center;margin-bottom:30px;width:100%;"><div style="width:95%;max-width:800px;background:linear-gradient(135deg,#16171b 0%,#0b0c0f 100%);border-radius:2vw;border:0.2vw solid #3c3d42;padding:3% 5%;box-shadow:0 1.5vw 4vw rgba(0,0,0,0.7);display:flex;flex-wrap:nowrap;align-items:center;gap:5%;position:relative;overflow:hidden;"><div style="flex-shrink:0;position:relative;z-index:2;width:25%;max-width:180px;"><div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:120%;height:120%;background:radial-gradient(circle,rgba(241,196,15,0.1) 0%,transparent 70%);z-index:-1;"></div><img src="{c_img}" style="width:100%;filter:drop-shadow(0 1vw 2vw rgba(0,0,0,0.9));display:block;"></div><div style="flex:1;z-index:2;min-width:0;"><div style="margin-bottom:2%;"><h1 style="margin:0;color:#f1c40f;font-size:calc(18px + 1.5vw);font-weight:900;letter-spacing:-0.1vw;text-shadow:0 0.3vw 0.6vw rgba(0,0,0,0.8);line-height:1.1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{c_name}</h1><div style="margin-top:1%;display:flex;align-items:center;gap:2%;color:#d1d1d1;white-space:nowrap;font-size:calc(10px + 0.3vw);"><span style="font-weight:700;background:rgba(255,255,255,0.05);padding:0.2vw 0.8vw;border-radius:0.4vw;">{world}</span><span>Lv.{c_lv}</span><span style="color:#444;">|</span><span>{c_class}</span></div></div><div style="margin-top:4%;"><div style="display:flex;justify-content:space-between;margin-bottom:1%;align-items:flex-end;"><span style="font-size:calc(8px + 0.2vw);color:#555;font-weight:900;letter-spacing:0.1vw;">EXP</span><span style="font-size:calc(10px + 0.4vw);color:#f1c40f;font-weight:900;font-family:monospace;">{c_exp}%</span></div><div style="width:100%;background:#000;border-radius:1vw;height:0.8vw;min-height:6px;overflow:hidden;border:0.1vw solid #2d2e34;padding:0.15vw;"><div style="width:{c_exp}%;background:linear-gradient(90deg,#8e8e93 0%,#f1c40f 100%);height:100%;border-radius:1vw;box-shadow:0 0 1vw rgba(241,196,15,0.5);"></div></div></div></div></div></div>'
